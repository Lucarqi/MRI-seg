...
parser.add_argument('--generator_A2B', type=str, default='output/cyclegan/7/netG_A2B.pth', help='A2B generator checkpoint file')
...
name = list(filter(lambda x: re.search('T2',x) is not None,allname))
