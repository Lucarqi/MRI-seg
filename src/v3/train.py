...
parser.add_argument('--save_root', type=str, default='output/cyclegan/4/', help='loss path to save')
...
# Dataset loader
dataloader = DataLoader(ImageDataset(transforms_['train'], opt, mode='train'), 
